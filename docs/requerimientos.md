...
- **RF-01 (Autenticación)**: Permitir el cambio fluido entre las vistas de "Iniciar Sesión" y "Crear Cuenta" dentro de una misma interfaz.
- **RF-02 (Gestión de Roles)**: Ocultar o mostrar dinámicamente las pestañas de navegación según el rol asignado (`admin`, `docente`, `estudiante`).
